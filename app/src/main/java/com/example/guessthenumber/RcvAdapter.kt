...
class RcvAdapter(private var msg: List<String>) :
    RecyclerView.Adapter<RcvAdapter.ViewHolder>() {
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        val msgtxt:TextView=itemView.findViewById(R.id.txtrcv)
        init {
...
//        val v=LayoutInflater.from(parent.context).inflate(R.layout.rv_layout_row,false)
//        return ViewHolder(v)
...
//        return ViewHolder(view)
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.msgtxt.text = msg[position]
    }
